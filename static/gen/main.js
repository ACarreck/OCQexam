...
class Main{
    ...
    constructor() {
        ...
        newQ.onclick = () =>{
            ...
            for (let x in freqInputDirect) freqInputDirect[x].value = 0
            for (let x in freqInputCoax) freqInputCoax[x].value = 0
            for (let x in freqInputRect) freqInputRect[x].value = 0
        }
